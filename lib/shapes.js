...
class Triangle extends Shape {
    constructor(textColor, text, fillColor){
        super()
...
//Each shape class should have a render() method
    render() {
        return `<polygon points="100,20 200,20 150,170" fill="${this.fillColor}" /><text x="150" y="100" fill="${this.textColor}" font-size="24" text-anchor="middle" alignment-baseline="middle">${this.text}</text>`
...
class Square extends Shape {
    ...
    //Each shape class should have a render() method
    render() {
        return `<rect x="100" y="50" width="100" height="100" fill="${this.fillColor}" /><text x="150" y="100" fill="${this.textColor}" font-size="24" text-anchor="middle" alignment-baseline="middle">${this.text}</text>`
